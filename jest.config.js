module.exports = {
  ...
  transformIgnorePatterns: [
    "/node_modules/(?!react|uuid|jest-cucumber|react-redux|react-router-dom|@reduxjs/toolkit|react-dom|react-dnd|react-dnd-html5-backend|react-chartjs-2|chart.js)/",
  ],
